...
-- ----------------------------
DROP TABLE IF EXISTS "wizwolf"."ad_system";
CREATE TABLE "wizwolf"."ad_system" (
                                       ...
                                       "releaseno" varchar(10) COLLATE "pg_catalog"."default",
                                       "supportunits" numeric(10,0),
                                       "password" varchar(20) COLLATE "pg_catalog"."default",
                                       "replicationtype" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'L'::bpchar,
                                       "idrangestart" numeric,
                                       "idrangeend" numeric,
                                       "ldaphost" varchar(60) COLLATE "pg_catalog"."default",
                                       "customprefix" varchar(60) COLLATE "pg_catalog"."default",
                                       "isjustmigrated" char(1) COLLATE "pg_catalog"."default" DEFAULT 'N'::bpchar,
                                       "dbinstance" varchar(60) COLLATE "pg_catalog"."default",
                                       "dbaddress" varchar(255) COLLATE "pg_catalog"."default",
                                       "noprocessors" numeric(10,0),
                                       "summary" varchar(255) COLLATE "pg_catalog"."default",
                                       "encryptionkey" varchar(255) COLLATE "pg_catalog"."default",
                                       "ldapdomain" varchar(255) COLLATE "pg_catalog"."default",
                                       "isautoerrorreport" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'Y'::bpchar,
                                       "record_id" numeric(10,0),
                                       "supportexpdate" timestamp(6),
                                       "processing" char(1) COLLATE "pg_catalog"."default",
                                       "supportemail" varchar(60) COLLATE "pg_catalog"."default",
                                       "isallowstatistics" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'Y'::bpchar,
                                       "statisticsinfo" varchar(60) COLLATE "pg_catalog"."default",
                                       "profileinfo" varchar(60) COLLATE "pg_catalog"."default",
                                       "oldname" varchar(60) COLLATE "pg_catalog"."default",
                                       "description" varchar(255) COLLATE "pg_catalog"."default",
                                       "systemstatus" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'E'::bpchar,
                                       "isfailonmissingmodelvalidator" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'Y'::bpchar,
                                       "lastbuildinfo" varchar(255) COLLATE "pg_catalog"."default",
                                       "isfailonbuilddiffer" char(1) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'N'::bpchar,
                                       "uuid" varchar(36) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
-- ----------------------------
INSERT INTO "wizwolf"."ad_system" VALUES (0, 0, 0, 'Y', '2006-08-10 20:22:41', 100, '2023-01-24 00:00:00', 100, '?', '?', '?', '2023-01-24', '3.9.4', 0, '?', 'L', NULL, NULL, NULL, NULL, 'N', 'adempiere.xe.', 'jdbc:postgresql://localhost:5432/adempiere?encoding=unicode', 8, NULL, NULL, NULL, 'Y', NULL, NULL, NULL, NULL, 'Y', 'C2U8B17P62I8L24M28', 'GardenWorld|SYSTEM|', NULL, NULL, 'E', 'Y', 'ADempiere Foundation Release 3.9.4 20230117-1854', 'N', 'a49f188c-fb40-11e8-a479-7a0060f0aa01');

-- ----------------------------
-- Checks structure for table ad_system
-- ----------------------------
ALTER TABLE "wizwolf"."ad_system" ADD CONSTRAINT "ad_system_isactive_check" CHECK (isactive = ANY (ARRAY['Y'::bpchar, 'N'::bpchar]));
ALTER TABLE "wizwolf"."ad_system" ADD CONSTRAINT "ad_system_isfailonbuilddiffer_check" CHECK (isfailonbuilddiffer = ANY (ARRAY['Y'::bpchar, 'N'::bpchar]));
ALTER TABLE "wizwolf"."ad_system" ADD CONSTRAINT "ad_system_isfailonmissingmodelvalidator_check" CHECK (isfailonmissingmodelvalidator = ANY (ARRAY['Y'::bpchar, 'N'::bpchar]));

-- ----------------------------
-- Primary Key structure for table ad_system
-- ----------------------------
ALTER TABLE "wizwolf"."ad_system" ADD CONSTRAINT "ad_system_pkey" PRIMARY KEY ("ad_system_id", "ad_client_id");
