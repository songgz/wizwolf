 ...
 */
public class CComboBox extends JComboBox implements CInput
{
	/**
	 * 
	 */
...
//	}   //  removeMouseListener
	...
	private class ReducibleModel implements MutableComboBoxModel, ListDataListener 
	{
		 ...
		 * Pass through to the wrapped model if underlying model is MutableComboBoxModel.
		 * 
		 * @see DefaultComboBoxModel#removeElement(Object)
		 */
		 ...
		 * 
		 * @see DefaultComboBoxModel#setSelectedItem(Object)
		 */
		 ...
		 *
		 * @param1 filtering true if the underlying model is to be filtered
		 */
